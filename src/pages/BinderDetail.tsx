...
const BinderDetail: React.FC = () => {
  ...
  const formatContent = (content: string) => {
    ...
    console.log('Content to format:', content.substring(0, 200) + '...');
    
    // Check if content still contains frontmatter (parsing failed)
    if (content.startsWith('---')) {
      console.warn('Content still contains frontmatter, parsing likely failed');
      // Try to extract just the body content after the second ---
